...
<main id="page-wrapper" class="page-wrapper">
    <div class="container contain-wrapper contain-edit">
        ...
        <form class="mt-4" action="{{ url('dash/info/lain/pelajar/') }}/{{ $pelajar->id }}" method="post">
            @method('patch')
            @csrf
            ...
            <div class="form-group mb-4">
                ...
                <select class="custom-select mr-sm-2" id="subcategory" name="subcategory">
                    ...
                    <option {{ ($subcategory->id == $pelajar->t_info_subcategory_id) ? 'selected' : '' }}
                        value="{{ $subcategory->id }}">{{ $subcategory->subcategory_name }}</option>
                    @endforeach
                </select>
            </div>

            <label for="pelajar">Status</label>
            ...
            <div class="modal-footer">
                <a href="{{ url('dash/info/lain/pelajar') }}" type="button" class="btn btn-light"
