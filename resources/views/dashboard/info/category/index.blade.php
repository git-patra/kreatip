...
<main id="page-wrapper" class="page-wrapper">
    <div class="container contain-wrapper">
        ...
        <button type="button" class="btn btn-rounded btn-outline-primary mt-3" data-toggle="modal"
            data-target="#add-category-info"><i class="fas fa-plus"></i> Add</button>

        <!-- Add modal content -->
        <div id="add-category-info" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <form action="{{ url('dash/info/category') }}" method="post" class="pl-3 pr-3">
                            @csrf

                            <div class="form-group">
                                <label for="category">Category</label>
                                <input class="form-control" type="text" id="category" name="category" required
                                    placeholder="Category Info" value="{{ old('category') }}">
                            </div>
        ...
        <table class="table table-striped table-hover mt-3">
            ...
            <tbody class="border border-primary text-center">
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ url('dash/info/category/') }}/{{ $category->id }}"
                            class="btn btn-rounded btn-outline-warning">
                            <i class="fas fa-edit"></i>
                        </a>

                        <form action="{{ url('dash/info/category/') }}/{{ $category->id }}" method="post"
                            class="d-inline">
                            @method('delete')
                            @csrf
